...
const createRestaurantDetailTemplate = (restaurant) => `
  ...
  <img class="restaurant__image" src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="${restaurant.name} image" crossorigin="anonymous" tabindex="0"/>
...
const createRestaurantItemTemplate = (restaurant) => `
  <article class="restaurant__item" tabindex="0 >
    <div class="restaurant__thumbnail">
      <img class="restaurant__image" src="${CONFIG.BASE_IMAGE_URL}/${restaurant.pictureId}" alt="${restaurant.name} image" crossorigin="anonymous">
